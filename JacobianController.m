...
if clientID > -1
   ...
   while(1)
       ...
       if b_cont == false
          vrep.simxSetObjectPosition(clientID,h_target,-1,[-0.4 ;-0.24;0.8],vrep.simx_opmode_blocking);
          vrep.simxSetObjectOrientation(clientID,h_target,-1,[45*pi/180,-45*pi/180,20*pi/180],vrep.simx_opmode_blocking); 
       end
